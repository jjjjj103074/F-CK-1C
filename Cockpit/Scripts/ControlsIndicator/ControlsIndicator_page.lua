...
-- STICK SCALE-----------------------------------------------------------------
local pitch_scale             = add_line("pitch_scale", { 0, -size_y_negative }, size_y_negative + size_y_positive, nil,
	90, base.name)
...
local throttle_scale = add_line("throttle_scale", { throttle_px, throttle_py }, throttle_scale_length, nil, 90, base
	.name)
local idle_scale = add_line("idle_scale",
	{ throttle_px - rud_shift * 0.5, throttle_py + throttle_scale_length * throttleIdle }, rud_shift, nil, nil, base
	.name)
local ab_scale = add_line("ab_scale",
	{ throttle_px - rud_shift * 0.5, throttle_py + throttle_scale_length * throttleMil },
	rud_shift, nil, nil, base.name)
