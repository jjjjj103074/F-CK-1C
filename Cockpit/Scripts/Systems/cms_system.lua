...
local CMD_TMS_UP = device_commands.TMSUp
...
local ICMD_PLANE_FIRE = dcs_commands.iCommandPlaneFire
local ICMD_PLANE_FIRE_OFF = dcs_commands.iCommandPlaneFireOff
local ICMD_PLANE_RADAR_ON_OFF = dcs_commands.iCommandPlaneRadarOnOff
local ICMD_PLANE_CHANGE_LOCK = dcs_commands.iCommandPlaneChangeLock
local ICMD_PLANE_CHANGE_WEAPON = dcs_commands.iCommandPlaneChangeWeapon
local ICMD_PLANE_MODE_BVR = dcs_commands.iCommandPlaneModeBVR
local ICMD_PLANE_MODE_VS = dcs_commands.iCommandPlaneModeVS
local ICMD_PLANE_MODE_BORE = dcs_commands.iCommandPlaneModeBore
local ICMD_PLANE_MODE_HELMET = dcs_commands.iCommandPlaneModeHelmet
local ICMD_PLANE_MODE_FI0 = dcs_commands.iCommandPlaneModeFI0
local ICMD_PLANE_MODE_CANNON = dcs_commands.iCommandPlaneModeCannon
local ICMD_PLANE_LAUNCH_PERMISSION_OVERRIDE = dcs_commands.iCommandPlaneLaunchPermissionOverride
local ICMD_PLANE_PICKLE_ON = dcs_commands.iCommandPlanePickleOn
local ICMD_PLANE_PICKLE_OFF = dcs_commands.iCommandPlanePickleOff
local ICMD_PLANE_LOCKON_START = dcs_commands.iCommandPlaneLockOnStart
local ICMD_PLANE_LOCKON_FINISH = dcs_commands.iCommandPlaneLockOnFinish
local ICMD_PLANE_CHANGE_LOCK_UP = dcs_commands.iCommandPlaneChangeLockUp
local ICMD_PLANE_DROP_SNAR_ONCE = dcs_commands.iCommandPlaneDropSnarOnce
local ICMD_PLANE_DROP_SNAR_ONCE_OFF = dcs_commands.iCommandPlaneDropSnarOnceOff
local ICMD_PLANE_DROP_FLARE_ONCE = dcs_commands.iCommandPlaneDropFlareOnce
local ICMD_PLANE_DROP_CHAFF_ONCE = dcs_commands.iCommandPlaneDropChaffOnce
