...
// Private AFCS implementation; consumers use FlightControlCommandSystem.
...
private:
	...
	std::uint64_t applied_vertical_guidance_reset_revision_ = 0;
	std::uint64_t applied_lateral_guidance_reset_revision_ = 0;
	std::uint64_t revision_ = 0;
	ConstraintReason constraint_reason_ = ConstraintReason::None;
	bool lateral_bypass_active_last_tick_ = false;
